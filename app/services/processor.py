...
def index_document(doc_id: str, chunks: list, embeddings: np.ndarray, index_dir: str = "index"):
    p = Path(index_dir)
    ...
    if registry.exists():
        ...
        reg = {}
    reg[doc_id] = {"emb_file": str(emb_file), "chunks_file": str(chunks_file)}
...
def process_document(doc_id: str, file_path: str):
    ...
    try:
        ...
        index_document(doc_id, chunks, embeddings)
        update_document(
            doc_id,
